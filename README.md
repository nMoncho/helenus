...
```scala
libraryDependencies += "net.nmoncho" %% "helenus-core" % "2.0.0-RC2+83-dfa7cdf4+20260902-0550-SNAPSHOT"
```

The type-safe [Tables DSL](#tables-dsl) lives in its own module (currently published for Scala 2.13 only):

```scala
libraryDependencies += "net.nmoncho" %% "helenus-tables" % "2.0.0-RC2+83-dfa7cdf4+20260902-0550-SNAPSHOT"
```
...
// rowMapper: RowMapper[Hotel] = net.nmoncho.helenus.internal.CaseClassRowMapperDerivation$$anonfun$net$nmoncho$helenus$internal$CaseClassRowMapperDerivation$$$nestedInanonfun$genericCCRowMapperBuilder$1$1@6a4ca30c
...
val hotelsById = "SELECT * FROM hotels WHERE id = ?".toCQL
    .prepare[String]
    .as[Hotel]
// hotelsById: internal.cql.ScalaPreparedStatement1[String, Hotel] = net.nmoncho.helenus.internal.cql.ScalaPreparedStatement1@6b105b9c
...
// interpolatedHotelsById: api.cql.WrappedBoundStatement[com.datastax.oss.driver.api.core.cql.Row] = net.nmoncho.helenus.api.cql.WrappedBoundStatement@1fa05a7d
...
// reusableHotelMapper: RowMapper[Hotel] = net.nmoncho.helenus.internal.CaseClassRowMapperDerivation$$anonfun$net$nmoncho$helenus$internal$CaseClassRowMapperDerivation$$$nestedInanonfun$genericCCRowMapperBuilder$1$1@2efc90b1
```
...
// res3: com.datastax.oss.driver.api.core.cql.ResultSet = com.datastax.oss.driver.internal.core.cql.SinglePageResultSet@1a055adb
...
UsersTable.insert
  ...
  .execute()
// res4: com.datastax.oss.driver.api.core.cql.ResultSet = com.datastax.oss.driver.internal.core.cql.SinglePageResultSet@3cf8d8a9

// Or insert a whole entity at once
UsersTable.insertFrom(User(userId, "alice", 30, "alice@example.com")).execute()
// res5: com.datastax.oss.driver.api.core.cql.ResultSet = com.datastax.oss.driver.internal.core.cql.SinglePageResultSet@6afbd128

// SELECT returns a PagingIterable of the mapped case class
val users = UsersTable.select()
  .where(UsersTable.id === userId)
  .execute()
// users: com.datastax.oss.driver.api.core.PagingIterable[User] = com.datastax.oss.driver.internal.core.PagingIterableWrapper@445fa9d9
...
UsersTable.update
  ...
  .execute()
// res6: com.datastax.oss.driver.api.core.cql.ResultSet = com.datastax.oss.driver.internal.core.cql.SinglePageResultSet@5c2507db

// DELETE
UsersTable.delete
  .where(UsersTable.id === userId and UsersTable.username === "alice")
  .execute()
// res7: com.datastax.oss.driver.api.core.cql.ResultSet = com.datastax.oss.driver.internal.core.cql.SinglePageResultSet@6dfabac3
...
// byId: internal.cql.ScalaPreparedStatement1[UUID, User] = net.nmoncho.helenus.api.tables.dml.ToPrepared$$anon$3$$anon$4@13810b06
```
