...
```scala
libraryDependencies += "net.nmoncho" %% "helenus-core" % "2.0.0-RC2+34-b3d5ac0a+20260817-1624-SNAPSHOT"
```

The type-safe [Tables DSL](#tables-dsl) lives in its own module (currently published for Scala 2.13 only):

```scala
libraryDependencies += "net.nmoncho" %% "helenus-tables" % "2.0.0-RC2+34-b3d5ac0a+20260817-1624-SNAPSHOT"
```
...
// session: CqlSession = com.datastax.oss.driver.internal.core.session.DefaultSession@55e755f1
...
// rowMapper: RowMapper[Hotel] = net.nmoncho.helenus.internal.CaseClassRowMapperDerivation$$anonfun$net$nmoncho$helenus$internal$CaseClassRowMapperDerivation$$$nestedInanonfun$genericCCRowMapperBuilder$1$1@c154d9
...
val hotelsById = "SELECT * FROM hotels WHERE id = ?".toCQL
    .prepare[String]
    .as[Hotel]
// hotelsById: internal.cql.ScalaPreparedStatement1[String, Hotel] = net.nmoncho.helenus.internal.cql.ScalaPreparedStatement1@29d83331
...
// interpolatedHotelsById: api.cql.WrappedBoundStatement[com.datastax.oss.driver.api.core.cql.Row] = net.nmoncho.helenus.api.cql.WrappedBoundStatement@1ccbedb7
...
// reusableHotelMapper: RowMapper[Hotel] = net.nmoncho.helenus.internal.CaseClassRowMapperDerivation$$anonfun$net$nmoncho$helenus$internal$CaseClassRowMapperDerivation$$$nestedInanonfun$genericCCRowMapperBuilder$1$1@6b93fd47
```
...
// res2: com.datastax.oss.driver.api.core.cql.ResultSet = com.datastax.oss.driver.internal.core.cql.SinglePageResultSet@64f3e406
...
UsersTable.insert
  ...
  .execute()
// res3: com.datastax.oss.driver.api.core.cql.ResultSet = com.datastax.oss.driver.internal.core.cql.SinglePageResultSet@63dfd7bf

// Or insert a whole entity at once
UsersTable.insertFrom(User(userId, "alice", 30, "alice@example.com")).execute()
// res4: com.datastax.oss.driver.api.core.cql.ResultSet = com.datastax.oss.driver.internal.core.cql.SinglePageResultSet@239c9fea

// SELECT returns a PagingIterable of the mapped case class
val users = UsersTable.select()
  .where(UsersTable.id === userId)
  .execute()
// users: com.datastax.oss.driver.api.core.PagingIterable[User] = com.datastax.oss.driver.internal.core.PagingIterableWrapper@54a5edad
...
UsersTable.update
  ...
  .execute()
// res5: com.datastax.oss.driver.api.core.cql.ResultSet = com.datastax.oss.driver.internal.core.cql.SinglePageResultSet@76336d12

// DELETE
UsersTable.delete
  .where(UsersTable.id === userId and UsersTable.username === "alice")
  .execute()
// res6: com.datastax.oss.driver.api.core.cql.ResultSet = com.datastax.oss.driver.internal.core.cql.SinglePageResultSet@11dae5df

// DROP TABLE
UsersTable.drop.ifExists.execute()
// res7: com.datastax.oss.driver.api.core.cql.ResultSet = com.datastax.oss.driver.internal.core.cql.SinglePageResultSet@2b26cc79
```
...
// byId: internal.cql.ScalaPreparedStatement1[UUID, User] = net.nmoncho.helenus.api.tables.dml.ToPrepared$$anon$3$$anon$4@2e002b38
```
