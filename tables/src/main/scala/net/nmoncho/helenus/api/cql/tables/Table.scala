...
import net.nmoncho.helenus.api.cql.tables.ddl._
import net.nmoncho.helenus.api.cql.tables.dml._
import net.nmoncho.helenus.api.cql.tables.dml.where._
import shapeless.::
...
sealed abstract class TableDef(val keyspace: String, val tableName: String) {
  ...
  class Column[T](val fieldName: String, val name: String, val frozen: Boolean)(
    ...
    final type Asc = net.nmoncho.helenus.api.cql.tables.Asc[Tag]

    /** This column sorted descending, e.g. `type CK = ts.Desc :: HNil`. */
    final type Desc = net.nmoncho.helenus.api.cql.tables.Desc[Tag]
