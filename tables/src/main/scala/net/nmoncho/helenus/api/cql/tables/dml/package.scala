...
import net.nmoncho.helenus.api.cql.tables.dml.where.BindPredicate
import net.nmoncho.helenus.api.cql.tables.dml.where.BoundPredicate
import net.nmoncho.helenus.api.cql.tables.dml.where.Predicate
